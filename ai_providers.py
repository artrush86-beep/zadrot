...
SYSTEM_PROMPT = (
    ...
    "Если в контексте ниже есть 'Актуальные данные крипторынка' или 'Результаты веб-поиска' — "
    "это реальные свежие данные, отвечай по ним прямо и уверенно, без 'наверное'/'думаю'/'проверь сам'. "
    "Если такого контекста нет и вопрос требует свежих фактов (цена, новости, курс) — "
    "честно скажи, что не видишь актуальных данных, а не выдумывай число."
)
